...
#   * http://www.snip2code.com/Snippet/211790/Updating-to-deactivate-virtualenv-is-we-
#   * http://nolar.info/automatically-activate-virtualenv-on-cd/
...
_virtualenv_auto_activate() {
    ...
    then
        ...
        then
            ...
            echo "$_virtualenv_path activated"
        fi
    else
